...
namespace FirstProjectCS.model
{
    internal class IspitnaPrijava
    {
        ...
        {
            return $"Ispitna prijava za studenta {this.student.Ime} iz predmeta {this.predmet.Naziv} u roku {this.ispitniRok.Naziv}| bodovi iz teorije: {this.teorija} | bodovi iz zadataka: {this.zadaci}";
        }
